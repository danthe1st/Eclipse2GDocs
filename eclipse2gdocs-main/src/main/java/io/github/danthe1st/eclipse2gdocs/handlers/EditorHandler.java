...
public final class EditorHandler implements IPartListener2, IDocumentListener {
	...
	private static GoogleDocsUploader setupOAuth2(ExecutionEvent event)
		...
		Dialog dlg = new MessageDialog(HandlerUtil.getActiveShell(event), "Please wait", null, "Please authorize the application in your web browser", 0, new String[] { "Cancel" }, 0);
